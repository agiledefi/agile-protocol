...
/**
 * @title Agile's ABNB Contract
 * @notice AToken which wraps BNB
 * @author Agile
 */
contract ABNB is AToken {
    /**
     * @notice Construct a new ABNB money market
    ...
    /**
     * @notice Send BNB to ABNB to mint
     */

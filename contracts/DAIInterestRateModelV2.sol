...
/**
  * @title Agile's DAIInterestRateModel Contract (version 2)
  * @author Agile (modified by Dharma Labs)
  * @notice The parameterized model described in section 2.4 of the original Agile Protocol whitepaper.

...
This checks to see if the deployed byte-code matches this version of the Agile Protocol.
...
(async function() {
  ...
  console.log(`Matching aToken at ${address} with ${JSON.stringify(conf)}`);
  ...
  await saddle.match(address, 'ABep20Immutable', deployArgs);
